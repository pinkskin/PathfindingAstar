...
public:
	...
	void setTileNodeHeuristic(sf::Vector2f const& quadCenterStart, 
		sf::Vector2f const& quadCenterEnd, TileNode& currentTileNode); //TODO
	...
	void changeTileNodeTexture(sf::Vector2f const& tileNodeUpLfVertScreenPos); //TODO: change a single tilenode's texture (static)
